...
class AppTests(TestCase):
    ...
    friend request from 'test1@email.edu'.
    ...
    def test_get_user(self):
        ...
        user_response = self.client.get(reverse('user'), {'email': self.TEST_EMAIL}, AUTHORIZATION=f'Bearer {token}')
    ...
    def test_user_requires_token(self):
        ...
        self.assertEqual(user_response['error'], 'access forbidden')
    ...
    def test_get_friends(self):
        ...
        friend_response = self.client.get(reverse('friends'), {'email': self.TEST_EMAIL}, AUTHORIZATION=f'Bearer {token}')
        ...
        self.assertEqual(friend_response.json()['friend_requests'][0]['email'], 'nelsonys@uw.edu')
